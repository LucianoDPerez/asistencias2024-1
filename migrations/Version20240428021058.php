 ...
 */
final class Version20240428021058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE params (id INT AUTO_INCREMENT NOT NULL, use_terms LONGTEXT DEFAULT NULL, real_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
